        ...
        <div className="max-w-4xl mx-auto bg-white shadow-xl shadow-brand-dark/5 rounded-2xl border border-brand-border overflow-hidden animate-fade-in">
          ...
          <div className="px-8 py-10 space-y-8 text-brand-gray leading-relaxed">
            ...
            <section>
              ...
              <p>When you create an account or sign in (via Supabase Auth), we collect:</p>
              ...
              <p>To enable synchronization across devices, the following data is <strong>securely stored</strong> on our servers (Supabase) with strict access controls:</p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <p className="mt-2 text-sm italic">All cloud data is protected by industry-standard security measures and accessible only through your authenticated account via Row-Level Security (RLS) policies.</p>
              ...
              <p>When you use a prompt, we store:</p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <p>To maintain Extension stability and security, we collect:</p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <p className="mt-2 text-sm">This technical data helps us fix bugs, prevent fraud, and improve reliability.</p>
              ...
              <p className="mt-2 text-sm">These are necessary for the Extension to function and remain on your device.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                ...
                <li><strong>Deleted Accounts:</strong> Upon request for deletion, your data is removed from our live databases within <strong>24 hours</strong>. Backups are purged within 30 days.</li>
            ...
            <section>
              ...
              <p>AI ChatWorks is not intended for users under 16. We do not knowingly collect data from children under 16. If you believe a child has provided us with personal information, please contact us immediately at <a href="mailto:info@ai-chatworks.com" className="text-brand-purple underline">info@ai-chatworks.com</a>.</p>
            </section>
