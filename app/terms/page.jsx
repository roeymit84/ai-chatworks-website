        ...
        <div className="max-w-4xl mx-auto bg-white shadow-xl shadow-brand-dark/5 rounded-2xl border border-brand-border overflow-hidden animate-fade-in">
          ...
          <div className="px-8 py-10 space-y-8 text-brand-gray leading-relaxed">
            ...
            <section>
              ...
              <p>AI ChatWorks is a browser extension designed to enhance your experience with AI platforms. Key features include a Prompt Library, Cloud Synchronization, Conversation Timeline Navigation, and a Marketplace for downloading prompt templates.</p>
              <p className="mt-4">The Service acts as an interface and utility layer over third-party AI providers (e.g., ChatGPT, Claude, Gemini). We are not affiliated with, endorsed by, or sponsored by these third-party providers.</p>
            </section>
            ...
            <section>
              ...
              <p>The Service (excluding User Content) and its original content, features, and functionality are and will remain the exclusive property of AI ChatWorks and its licensors. The Service is protected by copyright, trademark, and other intellectual property laws.</p>
              <p className="mt-4">You may not copy, modify, distribute, sell, or lease any part of the Service or its software without our express written permission.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">6. Data Privacy and Storage</h2>
              <ul className="list-disc pl-6 space-y-4">
                ...
                <li><strong>Privacy Policy:</strong> For detailed information about how we collect, use, and protect your data, please review our <a href="/privacy" className="text-brand-purple underline hover:text-brand-purple-dark">Privacy Policy</a>.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">7. Data Backup and Loss</h2>
              <ul className="list-disc pl-6 space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">8. Account Deletion and Data Retention</h2>
              <ul className="list-disc pl-6 space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">9. Prohibited Uses</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">10. Disclaimer of Warranties ("As Is")</h2>
              <p>The Service is provided on an "AS IS" and "AS AVAILABLE" basis. We utilize third-party services (such as Supabase for backend infrastructure and third-party AI providers) and cannot guarantee their uptime or availability.</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">11. Limitation of Liability</h2>
              <p>In no event shall AI ChatWorks, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:</p>
              ...
              <p className="mt-4">To the maximum extent permitted by law, our total liability to you for all claims arising out of or related to the Service shall not exceed the amount you paid us in the 12 months prior to the claim, or $100, whichever is greater.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">12. Termination</h2>
            ...
            <section>
              ...
              <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. We will try to provide at least 30 days' notice prior to any new material terms taking effect by:</p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <section>
              ...
              <p>These Terms shall be governed and construed in accordance with applicable international laws and consumer protection regulations.</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">15. Contact Us</h2>
